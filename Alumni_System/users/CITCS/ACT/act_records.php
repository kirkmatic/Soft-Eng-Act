...
<body>
    <?php
        include ("act_navigation.php");
    ?>
    <h1 class="text-lg text-center font-bold p-2">ACT Program Head Page</h1>
        <!-- Buttons -->
    ...
    <div class="mt-2 overflow-x-auto">
        <h2 class="text-md text-center font-medium">List of ACT Alumni Students</h2>
