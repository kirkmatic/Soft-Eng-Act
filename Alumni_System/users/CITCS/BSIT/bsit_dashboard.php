...
<body>
    <?php include('bsit_navigation.php'); ?>
    <div class="container mx-auto p-6">
        ...
        $student_count_query = "SELECT COUNT(*) as total_students FROM students_background_table WHERE program = 'BSIT'";
        $result = mysqli_query($conn, $student_count_query);
        $row = mysqli_fetch_assoc($result);
        $total_students = $row['total_students'];
        
        // Fetch work status counts
        $work_status_query = "SELECT work_status, COUNT(*) as count FROM students_background_table WHERE program = 'BSIT' GROUP BY work_status";
        ...
        $program_query = "SELECT batch_name, COUNT(*) as count FROM students_background_table WHERE program = 'BSIT' GROUP BY batch_name";
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white p-6 shadow rounded-lg flex items-center">
                    ...
                    <div class="flex flex-col">
                        <h2 class="text-lg font-semibold">Total BSIT Students</h2>
