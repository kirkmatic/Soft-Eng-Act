...
<body>
    <?php
        include ("bsit_navigation.php");
    ?>
    <h1 class="text-lg text-center font-bold p-2">BSIT Program Head Page</h1>
        <!-- Buttons -->
    ...
    <div class="mt-2 overflow-x-auto">
        <h2 class="text-md text-center font-medium">List of BSIT Alumni Students</h2>
