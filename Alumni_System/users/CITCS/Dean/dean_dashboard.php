...
<body>
    <?php include('dean_navigation.php'); ?>
    <div class="container mx-auto p-6">
        ...
        $student_count_query = "SELECT COUNT(*) as total_students FROM students_background_table WHERE department = 'CITCS'";
        $result = mysqli_query($conn, $student_count_query);
        $row = mysqli_fetch_assoc($result);
        $total_students = $row['total_students'];
        
        // Fetch work status counts
        $work_status_query = "SELECT work_status, COUNT(*) as count FROM students_background_table WHERE department = 'CITCS' GROUP BY work_status";
        ...
        $program_query = "SELECT program, COUNT(*) as count FROM students_background_table WHERE department = 'CITCS' GROUP BY program";
    ...
    <div class="w-full max-w-6xl px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white p-6 shadow rounded-lg flex items-center">
                    ...
                    <div class="flex flex-col">
                        <h2 class="text-lg font-semibold">Total CITCS Students</h2>
            ...
            <div class="bg-white p-4 shadow rounded-lg">
                <h2 class="text-xl font-semibold mb-4">Students per Program</h2>
                <div class="flex justify-center" style="height: 300px;">
