...
<body>
    <?php
        include ("dean_navigation.php");
    ?>
    <h1 class="text-lg text-center font-bold p-2">Dean's Page</h1>
    <div class="mt-2 overflow-x-auto">
        <h2 class="text-md text-center font-medium">List of CITCS Alumni Students</h2>
        <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
            ...
            <tbody>
                ...
                $query = "SELECT s.alumni_id, s.lastname, s.firstname, s.middlename, sb.year_graduated, sb.batch_name, sb.program 
                        FROM students_table AS s 
                        JOIN students_background_table AS sb ON s.alumni_id = sb.alumni_id 
                        WHERE TRIM(sb.program) IN ('BSCS', 'BSIT', 'ACT') 
                        LIMIT $limit OFFSET $offset";
