...
//             document.getElementById("updateLastname").value = this.dataset.lastname;
//             document.getElementById("updateFirstname").value = this.dataset.firstname;
//             document.getElementById("updateMiddlename").value = this.dataset.middlename;
//             document.getElementById("updateYear").value = this.dataset.year;
//             document.getElementById("updateBatch").value = this.dataset.batch;
//             document.getElementById("updateProgram").value = this.dataset.program;
