        ...
        <ul class="flex justify-between items-center px-6">
            ...
            <li>
                <ul class="flex space-x-6">
                    <li><a href="registrar_dashboard.php" class="text-white hover:text-gray-400 text-lg">Dashboard</a></li>
                    <li><a href="registrar_student_records.php" class="text-white hover:text-gray-400 text-lg">Student Info</a></li>
